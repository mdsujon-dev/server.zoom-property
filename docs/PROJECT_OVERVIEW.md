...
| `CORS_ORIGIN` | Comma-separated list of allowed origins, e.g. `https://yourdomain.com,https://admin.yourdomain.com`. **Do not use `*`** if you need cookies/auth headers to work — see note below. |
