# Training Institute Backend Documentation

এই folder এ Training Institute backend এর সব documentation থাকবে। যেকোনো নতুন feature, integration, বা architecture change এর জন্য এখানে সুন্দর করে docs লিখে রাখবো যাতে টিমের সবাই সহজে বুঝতে পারে।
